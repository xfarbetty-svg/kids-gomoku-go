...
5. **快取升級**：`sw.js` 快取推進至 `kids-games-v32`。
...
- 內容：完成「影子跟讀」統一命名、影音精聽室 ➔ 影子跟讀全流程橋接、YouTube 逐句播放整合、桌面捷徑與 sw 快取 v32。
- Git push：待 push 到 origin/main
